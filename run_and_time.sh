...
export POPLAR_ENGINE_OPTIONS='{"opt.useAutoloader":"true","target.syncReplicasIndependently":"true", "streamCallbacks.numWorkerThreads" : "16", "streamCallbacks.multiThreadMode": "dedicated", "opt.enableMultiAccessCopies":"false", "target.deterministicWorkers":"true"}'
